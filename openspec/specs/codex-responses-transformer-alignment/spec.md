# codex-responses-transformer-alignment Specification

## Purpose
TBD - created by archiving change align-codex-openai-gemini-transformers. Update Purpose after archive.
## Requirements
